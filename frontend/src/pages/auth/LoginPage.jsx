...
const LoginPage = () => {
  ...
  const copy = {
    eyebrow:     t('auth.login.eyebrow', null, 'IL TUO SPAZIO PROGETTUALE'),
    title:       t('auth.login.title',   null, 'Entra nel tuo spazio.'),
    subtitle:    t('auth.login.subtitle',null, 'Accedi al tuo Client Profile™ e continua il tuo Design Journey™.'),
    email:       t('auth.login.email',   null, 'Email'),
    password:    t('auth.login.password',null, 'Password'),
    emailPh:     t('auth.login.email_placeholder', null, 'nome@esempio.com'),
    pwPh:        t('auth.login.password_placeholder', null, '••••••••••'),
    remember:    t('auth.login.remember',null, 'Ricordami'),
    forgot:      t('auth.login.forgot',  null, 'Password dimenticata?'),
    submit:      t('auth.login.submit',  null, 'Entra nel tuo spazio'),
    or:          t('auth.login.or',      null, 'OPPURE'),
    pathsEyebrow:t('auth.login.paths_eyebrow', null, 'Nuovo nel mondo MOOD for DESIGN?'),
    pathsSub:    t('auth.login.paths_sub',     null, 'Scegli da dove iniziare.'),
    pathPrivate: t('auth.login.path_private',  null, 'Sono un cliente privato'),
    pathPro:     t('auth.login.path_pro',      null, 'Sono un professionista del design'),
    needHelp:    t('auth.login.need_help',     null, 'Hai bisogno di aiuto?'),
    support:     t('auth.login.support',       null, 'Scrivi al nostro studio'),
