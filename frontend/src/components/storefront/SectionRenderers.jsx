 ...
 *
 * Phase W refactor:
 *   The 4 Phase U inline editors (stats_band, magazine_grid, brand_logos,
 *   team_identity_card) + shared toolbar primitives + helpers now live in
 *   /renderers/. This file is reduced to the orchestrator + legacy renderers
 *   (StoreHero, DualCta, ValueProps, ProjectsPreview, Newsletter,
 *   LegacySectionRaw).
 */
...
import {
  FALLBACK_CHAIN, PILLAR_ICONS, ICON_MAP, getField, getSetting, EditableImage,
} from './renderers/shared';
import StatsBand from './renderers/StatsBandRenderer';
import MagazineGrid from './renderers/MagazineGridRenderer';
import BrandLogos from './renderers/BrandLogosRenderer';
import TeamIdentityCard from './renderers/TeamIdentityCardRenderer';
