...
export const LANGUAGE_REGISTRY = [
  ...
  { code: 'ar',    name: 'Arabic',          native_name: 'العربية',        enabled: false, public_enabled: false, blueprint_enabled: false, default_locale: false, rtl: true,  fallback_locale: 'en-US', sort_order: 70, ai_translation_enabled: true,  short: 'AR',    base: 'ar' },
