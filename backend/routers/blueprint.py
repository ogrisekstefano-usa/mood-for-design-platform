...
DEFAULT_I18N = {
    "en-US": {
        ...
        "nav": {"dashboard": "Dashboard", "leads": "Leads", "projects": "Projects",
                ...
                "calendar": "Calendar", "collections": "Collections",
                "activity": "Activity", "team": "Team", "clients": "Clients", "messages": "Messages",
                "reports": "Reports", "billing": "Billing", "integrations": "Integrations",
        ...
        "moodboards": {"title": "Moodboards", "subtitle": "Curated visual narratives for your projects.",
                       ...
                       "create.titleRequired": "Please enter a title for the moodboard.",
                       "create.timeout": "Creation is taking longer than expected. Please retry in a moment.",
                       "create.failed": "Couldn't create the moodboard. Please retry.",
                       ...
                       "editor.reset": "Reset",
                       "editor.imageMissing": "Image unavailable",
                       "editor.saveFailedHint": "Some edits could not be saved. Tap to retry.",
                       "editor.retry": "Retry",
                       "page.add": "Add page",
                       ...
                       "page.eyebrow": "Pages",
                       "page.ratio.portraitA4": "Portrait · A4",
                       "page.ratio.landscape169": "Landscape · 16:9",
                       "page.ratio.square": "Square · 1:1",
                       "page.ratio.editorial": "Editorial · 3:4",
                       "page.ratio.wide": "Wide · 2:1",
                       "page.ratio.coverLandscape": "Cover · 16:10",
                       "page.type.cover": "Cover",
                       "page.type.blank": "Blank",
                       "page.type.mood": "Mood",
                       "page.type.material_board": "Materials",
                       "page.type.product_grid": "Products",
                       "page.type.palette": "Palette",
                       "page.type.gallery": "Gallery",
                       "page.type.split_story": "Split story",
                       "page.type.quote": "Quote",
                       "page.type.technical_board": "Technical",
                       "page.type.floorplan": "Floor plan",
                       "page.type.proposal_summary": "Summary",
                       "page.type.approval": "Approval",
                       "skeleton.eyebrow": "Master layouts",
                       "skeleton.title": "Choose a page layout",
                       "skeleton.subtitle": "Editorial skeletons crafted for cinematic presentations. Pick one to start — every block stays fully editable.",
                       "skeleton.category.cover": "Cover",
                       "skeleton.category.narrative": "Narrative",
                       "skeleton.category.atmosphere": "Atmosphere",
                       "skeleton.category.materials": "Materials",
                       "skeleton.category.products": "Products",
                       "skeleton.category.closing": "Closing",
                       "skeleton.category.blank": "Blank",
                       "skeleton.hero_full_bleed": "Hero · Full bleed",
                       "skeleton.split_cover": "Split cover",
                       "skeleton.quote_page": "Quote page",
                       "skeleton.split_editorial": "Split editorial",
                       "skeleton.mood_triptych": "Mood · Triptych",
                       "skeleton.gallery_spread": "Gallery spread",
                       "skeleton.palette_composition": "Palette composition",
                       "skeleton.materials_grid": "Materials grid",
                       "skeleton.product_focus": "Product focus",
                       "skeleton.product_grid_6": "Product grid · 6",
                       "skeleton.approval_page": "Approval page",
                       "skeleton.blank": "Blank page",
                       "presentation.empty": "No pages to present yet.",
                       "presentation.chapters": "Chapters",
                       "presentation.transition.fade": "Fade",
                       "presentation.transition.dissolve": "Dissolve",
                       "presentation.transition.slow_slide_left": "Slow slide · left",
                       "presentation.transition.slow_slide_up": "Slow slide · up",
                       "presentation.transition.cinematic_zoom": "Cinematic zoom",
                       "presentation.transition.soft_blur_crossfade": "Soft blur crossfade",
                       "editor.page": "Page",
                       "editor.pageInspector": "Page settings",
                       "field.title": "Title",
                       "field.chapter": "Chapter label",
                       "field.chapterPlaceholder": "Concept · Atmosphere · Materials …",
                       "field.transition": "Transition",
                       "field.transitionIn": "On enter",
                       "field.transitionDuration": "Duration",
                       "field.visibility": "Visibility",
                       "field.hiddenFromClient": "Hide from client",
                       "field.hiddenFromClientHint": "This page won't appear in shared client presentations.",
                       "field.hiddenInPresentation": "Skip in presentation",
                       "field.hiddenInPresentationHint": "Useful for internal notes you keep in the editor only.",
                       "editor.crop": "Crop & focal",
                       "editor.eyebrow": "Moodboard",
                       "editor.autosaveOn": "Autosave on",
                       "library.title": "Add elements",
                       "library.tab.blocks": "Blocks",
                       "library.tab.content": "Content",
                       "library.section.primitives": "Structure",
                       "library.section.content": "Content",
                       "library.section.saved": "Saved elements",
                       ...
                       "tool.shape": "Shape",
                       "tool.line": "Line",
                       "tool.hotspot": "Hotspot",
                       "tool.note": "Note",
                       "editor.quickAdjust.eyebrow": "Quick adjust",
                       "editor.quickAdjust.title": "Frame your image",
                       "editor.quickAdjust.subtitle": "Set fit, focal point and a soft tone before the photo lands on the canvas. Fine-tune later from the right sidebar.",
                       "editor.quickAdjust.preview": "Preview",
                       "editor.quickAdjust.fit": "Fit",
                       "editor.quickAdjust.focal": "Focal point",
                       "editor.quickAdjust.adjust": "Adjustments",
                       "editor.quickAdjust.reset": "Reset",
                       "editor.quickAdjust.skip": "Skip",
                       "editor.quickAdjust.confirm": "Apply",
                       "editor.quickAdjust.focalHint": "Click the preview to set a custom focal point.",
                       "field.fit.cover": "Cover",
                       "field.fit.contain": "Contain",
                       "field.fit.fill": "Fill",
                       "field.focal.top": "Top",
                       "field.focal.bottom": "Bottom",
                       "field.focal.left": "Left",
                       "field.focal.right": "Right",
                       "field.focal.center": "Center",
                       ...
                       "shadow.dramatic": "Dramatic",
                       "editor.visualProps": "Block",
                       ...
                       "placeholder.replaceImage": "Replace with image",
                       "placeholder.replaceText": "Replace with text",
                       "placeholder.replacePalette": "Replace with palette",
                       "placeholder.replaceMaterial": "Replace with material",
                       "placeholder.replaceProduct": "Replace with product",
        ...
        "brand": {"name": "MOOD for DESIGN", "tagline": "A Blueprint OS™ Platform",
                  ...
                  "intro": "Brand Studio controls ONLY the visual identity of your public storefront: logo, palette, typography, tagline, contact. To edit navigation, footer, sections or journeys → go to Experience Studio.",
                  "controls": "Identity · Palette · Typography · Logo · Showroom",
                  "controlsLabel": "Controls public storefront:",
                  "section.identity": "Brand identity",
                  "section.identityKicker": "A · Identity",
                  "section.paletteKicker": "B · Palette",
                  "section.paletteTitle": "Colours",
                  "section.typographyKicker": "C · Typography",
                  "section.typographyTitle": "Fonts",
                  "field.public_name": "Public brand name",
                  "field.tagline": "Tagline",
                  "field.short_desc": "Short description",
                  "field.support_email": "Support email",
                  "field.phone": "Phone",
                  "field.website": "Website URL",
                  "field.primary_logo": "Primary logo URL",
                  "field.display": "Display (Headlines)",
                  "field.body": "Body (UI)",
                  "i18nHint": "You are editing values for {locale}. The public site shows the value of the visited locale — a German visitor sees the de-DE version.",
        ...
        "module.concierge": "Concierge", "module.library": "Library",
        "nav.library": "Library", "nav.materials": "Materials",
...
DEFAULT_I18N["it"] = {
    ...
    "nav": {"dashboard": "Dashboard", "leads": "Lead", "projects": "Progetti",
            ...
            "library": "Archivio", "materials": "Materiali",
            "calendar": "Calendario", "collections": "Collezioni",
            "activity": "Attività", "team": "Team", "clients": "Clienti", "messages": "Messaggi",
            "reports": "Report", "billing": "Billing", "integrations": "Integrazioni",
            "experienceStudio": "Experience Studio",
            "projectsStudio": "Projects Studio",
            "editorialStudio": "Magazine · Market Editions",
            "editorialCalendar": "Editorial Calendar",
            "publishingQueue": "Publishing Queue",
            "mediaLibrary": "Media Library",
            "pinterestResearch": "Pinterest Research",
            "formsJourneys": "Forms & Journeys",
            "internationalPresence": "Presenza Internazionale",
            "brand": "Brand Studio",
            "section.workspace": "Workspace", "section.content": "Contenuti",
            "section.collaboration": "Collaborazione",
            "section.editorial": "Editorial Operations", "section.studio": "Studio",
    ...
    "moodboards": {"title": "Moodboard", "subtitle": "Narrazioni visive curate per i tuoi progetti.",
                   ...
                   "create.submit": "Crea",
                   "create.titleRequired": "Inserisci un titolo per il moodboard.",
                   "create.timeout": "La creazione sta richiedendo più tempo del previsto. Riprova fra un istante.",
                   "create.failed": "Non è stato possibile creare il moodboard. Riprova.",
                   ...
                   "editor.resetCrop": "Ripristina ritaglio",
                   "editor.adjustments": "Regolazioni",
                   "editor.reset": "Reset",
                   "editor.imageMissing": "Immagine non disponibile",
                   "editor.saveFailedHint": "Alcune modifiche non sono state salvate. Tocca per riprovare.",
                   "editor.retry": "Riprova",
                   ...
                   "page.eyebrow": "Pagine",
                   "page.ratio.portraitA4": "Verticale · A4",
                   "page.ratio.landscape169": "Orizzontale · 16:9",
                   "page.ratio.square": "Quadrato · 1:1",
                   "page.ratio.editorial": "Editoriale · 3:4",
                   "page.ratio.wide": "Panoramico · 2:1",
                   "page.ratio.coverLandscape": "Copertina · 16:10",
                   "page.type.cover": "Copertina",
                   "page.type.blank": "Vuota",
                   "page.type.mood": "Mood",
                   "page.type.material_board": "Materiali",
                   "page.type.product_grid": "Prodotti",
                   "page.type.palette": "Palette",
                   "page.type.gallery": "Galleria",
                   "page.type.split_story": "Split story",
                   "page.type.quote": "Citazione",
                   "page.type.technical_board": "Tecnico",
                   "page.type.floorplan": "Planimetria",
                   "page.type.proposal_summary": "Riepilogo",
                   "page.type.approval": "Approvazione",
                   "skeleton.eyebrow": "Master layout",
                   "skeleton.title": "Scegli un layout di pagina",
                   "skeleton.subtitle": "Schemi editoriali pensati per presentazioni cinematografiche. Sceglilo per iniziare — ogni blocco resta completamente modificabile.",
                   "skeleton.category.cover": "Copertina",
                   "skeleton.category.narrative": "Narrazione",
                   "skeleton.category.atmosphere": "Atmosfera",
                   "skeleton.category.materials": "Materiali",
                   "skeleton.category.products": "Prodotti",
                   "skeleton.category.closing": "Chiusura",
                   "skeleton.category.blank": "Vuoto",
                   "skeleton.hero_full_bleed": "Hero · Full bleed",
                   "skeleton.split_cover": "Copertina divisa",
                   "skeleton.quote_page": "Pagina citazione",
                   "skeleton.split_editorial": "Editoriale diviso",
                   "skeleton.mood_triptych": "Mood · Trittico",
                   "skeleton.gallery_spread": "Spread galleria",
                   "skeleton.palette_composition": "Composizione palette",
                   "skeleton.materials_grid": "Griglia materiali",
                   "skeleton.product_focus": "Focus prodotto",
                   "skeleton.product_grid_6": "Griglia prodotti · 6",
                   "skeleton.approval_page": "Pagina approvazione",
                   "skeleton.blank": "Pagina vuota",
                   "presentation.empty": "Nessuna pagina da presentare.",
                   "presentation.chapters": "Capitoli",
                   "presentation.transition.fade": "Dissolvenza",
                   "presentation.transition.dissolve": "Cross-dissolve",
                   "presentation.transition.slow_slide_left": "Slide lento · sinistra",
                   "presentation.transition.slow_slide_up": "Slide lento · alto",
                   "presentation.transition.cinematic_zoom": "Zoom cinematografico",
                   "presentation.transition.soft_blur_crossfade": "Blur crossfade",
                   "editor.page": "Pagina",
                   "editor.pageInspector": "Impostazioni pagina",
                   "field.title": "Titolo",
                   "field.chapter": "Etichetta capitolo",
                   "field.chapterPlaceholder": "Concept · Atmosfera · Materiali …",
                   "field.transition": "Transizione",
                   "field.transitionIn": "All'entrata",
                   "field.transitionDuration": "Durata",
                   "field.visibility": "Visibilità",
                   "field.hiddenFromClient": "Nascondi al cliente",
                   "field.hiddenFromClientHint": "Questa pagina non comparirà nelle presentazioni condivise.",
                   "field.hiddenInPresentation": "Salta in presentazione",
                   "field.hiddenInPresentationHint": "Utile per note interne visibili solo nell'editor.",
                   "editor.crop": "Ritaglio e focal point",
                   "editor.eyebrow": "Moodboard",
                   "editor.autosaveOn": "Salvataggio automatico attivo",
                   "library.title": "Aggiungi elementi",
                   "library.tab.blocks": "Blocchi",
                   "library.tab.content": "Contenuti",
                   "library.section.primitives": "Struttura",
                   "library.section.content": "Contenuti",
                   "library.section.saved": "Elementi salvati",
                   "library.personal": "Libreria personale",
                   "content.image": "Immagine",
                   "content.product": "Prodotto",
                   "content.material": "Materiale",
                   "content.text": "Testo",
                   "content.note": "Nota",
                   "content.video": "Video",
                   "content.pdf": "PDF",
                   ...
                   "tool.deselect": "Deseleziona",
                   "tool.move": "Sposta",
                   "tool.resize": "Ridimensiona",
                   "tool.text": "Testo",
                   "tool.image": "Immagine",
                   "tool.gallery": "Galleria",
                   "tool.product": "Prodotto",
                   "tool.material": "Materiale",
                   "tool.palette": "Palette",
                   "tool.shape": "Forma",
                   "tool.line": "Linea",
                   "tool.hotspot": "Hotspot",
                   "tool.note": "Note",
                   "editor.quickAdjust.eyebrow": "Anteprima rapida",
                   "editor.quickAdjust.title": "Inquadra la tua immagine",
                   "editor.quickAdjust.subtitle": "Imposta adattamento, focal point e un primo tono prima che la foto entri nel canvas. Affina dopo dalla sidebar.",
                   "editor.quickAdjust.preview": "Anteprima",
                   "editor.quickAdjust.fit": "Adattamento",
                   "editor.quickAdjust.focal": "Focal point",
                   "editor.quickAdjust.adjust": "Regolazioni",
                   "editor.quickAdjust.reset": "Ripristina",
                   "editor.quickAdjust.skip": "Salta",
                   "editor.quickAdjust.confirm": "Applica",
                   "editor.quickAdjust.focalHint": "Clicca sull'anteprima per impostare un focal point personalizzato.",
                   "field.fit.cover": "Riempi",
                   "field.fit.contain": "Contieni",
                   "field.fit.fill": "Distorci",
                   "field.focal.top": "Alto",
                   "field.focal.bottom": "Basso",
                   "field.focal.left": "Sinistra",
                   "field.focal.right": "Destra",
                   "field.focal.center": "Centro",
                   ...
                   "field.brightness": "Luminosità",
                   "field.contrast": "Contrasto",
                   "field.saturation": "Saturazione",
                   "field.warmth": "Calore",
                   "field.grayscale": "Bianco e nero",
                   "field.blur": "Sfocatura",
                   "field.vignette": "Vignettatura",
                   "field.borderRadius": "Arrotondamento",
                   "field.shadow": "Ombra",
                   "shadow.none": "Nessuna",
                   "shadow.soft": "Soffice",
                   "shadow.medium": "Media",
                   "shadow.dramatic": "Drammatica",
                   "editor.visualProps": "Blocco",
                   ...
                   "templates.pageCount": "{count} pagine",
                   "placeholder.replaceImage": "Sostituisci con immagine",
                   "placeholder.replaceText": "Sostituisci con testo",
                   "placeholder.replacePalette": "Sostituisci con palette",
                   "placeholder.replaceMaterial": "Sostituisci con materiale",
                   "placeholder.replaceProduct": "Sostituisci con prodotto",
    ...
    "module.inspirations": "Inspirations", "module.insights": "Insights",
    "module.concierge": "Concierge", "module.library": "Archivio",
    "nav.library": "Archivio", "nav.materials": "Materiali",
    "form": {"required": "Campo richiesto", "invalid_email": "Email non valida",
             "password_min": "La password deve avere almeno 8 caratteri"},
    "brand": {"name": "MOOD for DESIGN", "tagline": "A Blueprint OS™ Platform",
              "title": "Identità & Tema",
              "intro": "Brand Studio controlla SOLO l'identità visiva del tuo storefront pubblico: logo, palette, tipografia, tagline, contatti. Per modificare navigazione, footer, sezioni o journey → vai su Experience Studio.",
              "controls": "Identità · Palette · Tipografia · Logo · Showroom",
              "controlsLabel": "Controlla lo storefront pubblico:",
              "section.identity": "Identità del brand",
              "section.identityKicker": "A · Identità",
              "section.paletteKicker": "B · Palette",
              "section.paletteTitle": "Colori",
              "section.typographyKicker": "C · Tipografia",
              "section.typographyTitle": "Caratteri",
              "field.public_name": "Nome pubblico del brand",
              "field.tagline": "Tagline",
              "field.short_desc": "Descrizione breve",
              "field.support_email": "Email di supporto",
              "field.phone": "Telefono",
              "field.website": "Sito web",
              "field.primary_logo": "URL logo principale",
              "field.display": "Display (Titoli)",
              "field.body": "Body (Interfaccia)",
              "i18nHint": "Stai modificando i valori per {locale}. Il sito pubblico mostra il valore del locale visitato — un visitatore tedesco vede la versione de-DE.",
              "save": "Salva modifiche", "discard": "Annulla modifiche"},
}
DEFAULT_I18N["en-GB"] = {
