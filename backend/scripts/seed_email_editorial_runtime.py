...
TEMPLATES = {
    ...
    'system-email-partnership-request': [
        ('partnership_request.subject',
         'meta',
         '{{studio_name}} · Conversazione di collaborazione avviata'),
        ('partnership_request.preheader',
         'meta',
         'Una partnership inizia con una conversazione attenta.'),
        ('partnership_request.eyebrow',
         'meta',
         'Partnership'),
        ('partnership_request.title',
         'narrative',
         'Benvenuto nella rete di {{studio_name}}.'),
        ('partnership_request.body',
         'narrative',
         "Abbiamo ricevuto la tua richiesta di collaborazione. Il nostro team la sta "
         "valutando e ti contatterà presto per costruire insieme i prossimi passi."),
        ('partnership_request.cta',
         'cta_label',
         'Esplora il nostro network'),
        ('partnership_request.legal',
         'meta',
         "Questa email è una conferma automatica della tua richiesta di partnership."),
    ],
