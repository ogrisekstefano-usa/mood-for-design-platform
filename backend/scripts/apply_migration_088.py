"""Apply migration 088 — Real Conversation Engine™ (Sprint B)."""
import os
...
for tbl in ("relationship_threads", "relationship_messages", "relationship_memory_fragments"):
    cur.execute(
...
print("\n\u2705 088 applied · Real Conversation Engine ready.")
