...
STOREFRONT_SECTION_TYPES: List[Dict[str, Any]] = [
    ...
    # ── PARTNER APPLICATION form labels ────────────────────────────────────
    {
        "type": "partner_form_labels",
        "category": "partner-application",
        "label": "Partner Form Labels",
        "description": "Tutte le label, placeholder, messaggi di validazione e opzioni del form di candidatura partner. 100% governabile dal cliente per ogni lingua.",
        "icon": "FormInput",
        "reusable_in": ["partner-application"],
        "schema": {
            "s1_title":          {"type": "string", "i18n": True, "max": 120},
            "s2_title":          {"type": "string", "i18n": True, "max": 120},
            "s3_title":          {"type": "string", "i18n": True, "max": 120},
            "s4_title":          {"type": "string", "i18n": True, "max": 120},
            "field_nome":        {"type": "string", "i18n": True},
            "field_cognome":     {"type": "string", "i18n": True},
            "field_studio":      {"type": "string", "i18n": True},
            "field_email":       {"type": "string", "i18n": True},
            "field_telefono":    {"type": "string", "i18n": True},
            "field_ruolo":       {"type": "string", "i18n": True},
            "field_sito":        {"type": "string", "i18n": True},
            "field_instagram":   {"type": "string", "i18n": True},
            "field_linkedin":    {"type": "string", "i18n": True},
            "field_area":        {"type": "string", "i18n": True},
            "field_tipo_collab": {"type": "string", "i18n": True},
            "field_interessi":   {"type": "string", "i18n": True},
            "field_racconto":    {"type": "string", "i18n": True},
            "ph_ruolo":          {"type": "string", "i18n": True},
            "ph_collab":         {"type": "string", "i18n": True},
            "ph_racconto":       {"type": "string", "i18n": True},
            "cta_submit":        {"type": "string", "i18n": True},
            "privacy_text":      {"type": "richtext", "i18n": True},
            "error_generic":     {"type": "string", "i18n": True},
            "error_required":    {"type": "string", "i18n": True},
            "roles":        {"type": "array", "item": {"value": {"type": "string"}, "label": {"type": "string"}}},
            "collab_types": {"type": "array", "item": {"value": {"type": "string"}, "label": {"type": "string"}}},
            "interests":    {"type": "array", "item": {"id":    {"type": "string"}, "label": {"type": "string"}}},
        },
        "defaults": {},
    },
]
