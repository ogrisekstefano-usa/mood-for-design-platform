...
from routers import journey_mail
...
# STORE-004 · Project Story™ (Jun 2026)
...
# STORE-005 · Lead → Prospect → Design Journey™ (Jun 2026)
from routers import lead_conversion as _lead_conversion_router  # noqa: E402
api_router.include_router(_lead_conversion_router.router, tags=["lead-conversion"])
...
# STORE-012B · MOODBOARD V2.1 · Working Moodboard (Feb 2026)
from routers import working_moodboards as _working_moodboards_router  # noqa: E402
api_router.include_router(_working_moodboards_router.router, tags=["working-moodboards"])
